...
$('canvas').mouseenter(function() {
    ...
    var skillsList = [
                 ...
                 ['html', '<p>In the world of Web Development, there may be no duo more iconic than HTML (Hyper Text Markup Language) and CSS (Cascading Style Sheets).</p><br><p></p>', 'https://www.w3.org/standards/webdesign/htmlcss', 'Learn more about HTML/CSS']
    ]
