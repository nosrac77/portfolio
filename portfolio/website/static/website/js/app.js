...
$('canvas').mouseenter(function() {
    ...
    var skillsList = [
                 ...
                 ['django', '<p>Named after the French guitarist Jean "Django" Reinhardt, Django is an open-source web framework written entirely in the programming language Python. Since it\'s public released in 2005, Django has become </p><br><p></p>', 'https://www.djangoproject.com/', 'Learn more about Django']
    ]
