...
$('canvas').mouseenter(function() {
    ...
    var skillsList = [
                 ...
                 ['html', '<p>In the world of Web Development, there may be no other duo more iconic than HTML (Hypertext Mark-up Language) and CSS (Cascading Style Sheets). The undeniable standard markup language for creating webpages and web applications, HTML describes the structure and content for the webpages that employ it (which is nearly all webpages on the internet) through tags that represent HTML elements. While HTML is busy telling your browser what to interpret, CSS is a style sheet language designed to describe how a markup document should be presented. According to statistics from W3techs.com CSS is used in a staggering 95.7% of all websites - and for good reason! It\'s ability to style the layout, colors, text, organization, and general appearance enable a powerful separation of presentation and allow for quick and easy graphic design changes.</p><br><p>I write in HTML and CSS when developing any webpage.</p>', 'https://www.w3.org/standards/webdesign/htmlcss', 'Learn more about HTML/CSS'],
                 ['bootstrap', '<p></p><br><p></p>', 'https://getbootstrap.com/', 'Learn more about Boostrap']
    ]
