...
$('canvas').mouseenter(function() {
    ...
    var skillsList = [
                 ...
                 ['javascript', '<p>Not to be confused with the popular programming language Java, JavaScript is an interpreted high-level programming language best known for providing interactive user-interfaces to web-based applications. Alongside the likes of HTML and CSS, JavaScript is a staple in developing modern websites with built-in support from all major web-browsers.</p>', 'https://developer.mozilla.org/en-US/docs/Learn/Getting_started_with_the_web/JavaScript_basics', 'Learn more about JavaScript']
    ]
    for (var i = 0; i < skillsList.length; i++) {
        if (skillsList[i][0] == focusEl.attr('id')) {
            ...
            if (skillEl.html() != skillText) {
                ...
                canvasEls.next().animate({fontSize: '16px'}, 200);
                focusEl.next().animate({fontSize: '1.4em'}, 200);
